...
<!DOCTYPE html>
<html lang="en"></html>
<!-- The HTML file for Company Account -->
    ...
    <body>
        ...
        <section>
            <div class="wrapper">
                ...
                <div class="form">
                    <form id="form" action="newcompanyacc.php" method="post">
                        <div class="input-field">
                            <label>Company Name</label>
                            <input id="CompanyName" name="companyName" type="text" class="input" required>
                        </div>
                        ...
                        <div class="input-field">
                            <input id="checkCompanyRegister" name="c-register-btn" type="submit"class="submit-button" >
                        </div>
                    </form>

                    <P>
                        Have an account for this Company?
                        <!-- Links to the log in page  -->
                        <a href="Company login.php" class="new-acc">Sign In with your Company</a>
                   </P>

                   <P>
                       Have an account for just yourself?
